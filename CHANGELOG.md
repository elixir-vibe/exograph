...
- Reworked storage v2 to persist whole-file ASTs once on `files`, hydrate fragments by node locators, drop persisted fragment AST blobs and fragment term arrays, and remove the unused `tree_nodes` table.
