...
2. **Increase ingestion flush granularity**
   ...
   - A larger shared buffer threshold (`200000`) and a naive async flush prototype did not help; revisit with a proper per-source worker or explicit supervised flush protocol if pursuing this path.
