defmodule Exograph.PatternAudit do
  @moduledoc "Verifies indexed structural patterns across an Exograph corpus."

  import Ecto.Query

  alias Exograph.{DuckDBShards, Index, ShardedIndex}
  alias Exograph.PatternAudit.{Finding, Pattern, Result}
